...
public class DashboardConstants {
    ...
    public static final String ACTIVE_BUTTON = "xpath://img[@alt=\"Workspace dropdown options\"]";
    ...
    public static final String MANAGE_BUTTON = "xpath://img[@alt=\"Three dots icon\"]";
